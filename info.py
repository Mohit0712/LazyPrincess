...
# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 160))
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @LazyDeveloper \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10  /n <b>Free Horror Movies : <a href="https://BhootBazar.online"> Click here </a></b>")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '5d6505709fb29c5d45cd44c9fe75ba6c913252b8')
